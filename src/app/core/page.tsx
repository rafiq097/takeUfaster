                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {subject.keyTopics.length > 4 && (
                    <span className="px-2 py-1 bg-gray-700 text-gray-400 rounded text-xs">
                      +{subject.keyTopics.length - 4} more
                    </span>
                  )}
                </div>
              </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="p-6 border border-gray-800 rounded-xl">
              ...
              <div className="text-gray-400 text-sm">Total Topics</div>
            </div>
            <div className="p-6 border border-gray-800 rounded-xl">
            ...
            <div className="p-6 border border-gray-800 rounded-xl">
              <div className="text-3xl font-bold text-blue-400 mb-2">10-13</div>
              <div className="text-gray-400 text-sm">Weeks</div>
            </div>
            <div className="p-6 border border-gray-800 rounded-xl">
              <div className="text-3xl font-bold text-blue-400 mb-2">100%</div>
              <div className="text-gray-400 text-sm">Interview Ready</div>
            </div>
          </div>
        </div>
      </section>
