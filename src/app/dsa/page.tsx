  ...
  const sheets = [
    {
      ...
      description:
        "Essential coding problems handpicked by Striver for quick interview preparation",
      problems: 79,
    ...
    },
    {
      ...
      name: "SDE Sheet",
      description:
        "Comprehensive problem set covering all major topics for Software Development Engineer interviews",
      problems: 191,
      difficulty: "Intermediate to Advanced",
    ...
    },
    {
      ...
      name: "A to Z DSA",
      description:
        "Complete DSA roadmap from absolute basics to advanced topics with systematic learning approach",
      problems: 450,
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      >
        ...
        <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
          Choose your learning path with our curated problem sheets designed for
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Problems selected by industry professionals and competitive
                programmers
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Questions frequently asked in top tech company interviews
              </p>
            </div>
            <div className="text-center">
              <div className="p-3 bg-blue-600/20 rounded-full w-12 h-12 mx-auto mb-4 flex items-center justify-center">
      ...
      <footer className="container mx-auto px-6 py-12 text-center border-t border-gray-800 mt-16">
        <div className="text-gray-400">
          Ready to accelerate your coding journey? Choose a sheet and start
          solving!
        </div>
      </footer>
    </div>
